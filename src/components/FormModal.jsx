      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          >
            ...
            <option className="text-sm" value="Abdelrahman">
              Abdelrahman
            </option>
            <option className="text-sm" value="Nada">
              Mai
            </option>
            <option className="text-sm" value="Abdelrahman & Mai">
              Abdelrahman & Mai
            </option>
          </select>
        </div>
        ...
        <span className="text-[12px] text-gray-700 mb-4 block text-center">
          ...
          <span> Abdelrahman </span> and
          <span> Mai </span> can access the messages.
        </span>
